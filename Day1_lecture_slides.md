...
Expectations
========================================================
1. __Our first communication language is English__  
    *You can selectively use Korean (as I can understand Korean well)*

1. __Labs will be run by TAs__  
    *Due to TZ issue, instructor will answer your questions on the lab projects in the evening (Korea Time)*
...
5 min: Discuss briefly about what the informed decisions might be in your domain/field

5 min: Share your team's example(s) when you come back to the main room.

Typical Data Science Project Workflow
===================
<img src="./images/data-science.png" title="Data Wrangling" alt="Data Wrangling" width="80%" style="display: block; margin: auto;" />
...
R or Python?
=============
R is Useful and easier to do Statistical Modeling
...
[Hands-On] Learn R's Documentation Tools 
========================
__R Markdown__

1. Create a new R Markdown (Rmd) file
1. 
